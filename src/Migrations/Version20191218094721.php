 ...
 */
final class Version20191218094721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, etape_id_id INT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, coordinates LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_B8755515CFDE1A29 (etape_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE etape (id INT AUTO_INCREMENT NOT NULL, voyage_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, pays VARCHAR(255) NOT NULL, ville VARCHAR(255) DEFAULT NULL, latitude VARCHAR(255) NOT NULL, coordinates LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, photo VARCHAR(255) DEFAULT NULL, budget DOUBLE PRECISION DEFAULT NULL, INDEX IDX_285F75DD75D4A2B8 (voyage_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trajet (id INT AUTO_INCREMENT NOT NULL, activite_id_id INT NOT NULL, type_transport VARCHAR(255) NOT NULL, duree VARCHAR(255) DEFAULT NULL, coordinates_arrivee LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_2B5BA98CC1385E5E (activite_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, photo_profil VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98CC1385E5E FOREIGN KEY (activite_id_id) REFERENCES activite (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trajet DROP FOREIGN KEY FK_2B5BA98CC1385E5E');
